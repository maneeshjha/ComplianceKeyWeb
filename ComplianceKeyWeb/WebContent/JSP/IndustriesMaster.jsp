...
<title>Industries Master</title>
</head>
<body>
<html:form action="/industriesAction.do?reqCode=inserIndustryInfo" enctype="multipart/form-data">
<table align="center">
...
<%} %>
<tr>
<td>Industries  Name: &nbsp; &nbsp;</td> <td><html:text property="industryName" value=""/></td>
</tr>
<tr>
