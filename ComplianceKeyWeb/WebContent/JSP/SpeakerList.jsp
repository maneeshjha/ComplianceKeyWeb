...
<table align="center">
<tr>
<td class="normaltext">Speaker Name:</td> <td><html:text property="speakerName" value="" styleClass="typeToSearch" title="Please Enter Speaker Name" onkeyup="return getStatusWiseSpeakerName(this,event)"/><div id="divSpeakerName" class="ajaxDiv"></div></td>
</tr>
