...
<script language="javaScript" src="<%=request.getContextPath()%>/js/Master/ArticleMaster.js"></script>	
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/ddaccordion.js"></script><script>
...
<body>
<html:form action="/articleAction.do">
<input type="hidden" name="reqCode" value="" />	
<html:hidden property="articleId"/>
<table align="center">
<tr>
<td class="normaltext">Article  Name:</td> <td><html:text property="articleName" value="" styleClass="typeToSearch" title="Please Enter Article Name" onkeyup="return getStatusWiseSpeakerName(this,event)"/><div id="divSpeakerName" class="ajaxDiv"></div></td>
</tr>
...
<tr><td><input type="button" value="Search"/></td><td><input type="button" value="Clear"/></td><td><input type="button" value="AddNew" onClick="return showAddArticleMasterPage()"/> </td></tr>
</table>
</html:form>
</body>
